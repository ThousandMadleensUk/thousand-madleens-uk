...
export default function CampaignProgress({ campaignId = 143268 }: CampaignProgressProps) {
  ...
  return (
    <div className="bg-white rounded-lg border-2 border-green-200 shadow-lg overflow-hidden h-full flex flex-col">
      {/* Banner Image */}
      <div className="w-full min-h-48 flex-grow overflow-hidden relative">
        <Image
